...
namespace Dynamic.WorldInterface.Sensor
{
    ...
    public class DetectGroundAndWall2DSensor : BaseSensor
    {
        ...
        {
            Data.TouchingGround2DPoint = Physics2D.Raycast(groundCheck.position, Vector2Int.down, groundCheckRadius, layer);
