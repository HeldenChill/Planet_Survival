...
namespace _Game.Character
{
    ...
    public class PlayerLogicModule : AbstractLogicModule<PlayerLogicData, PlayerLogicParameter, LogicEvent>
    {
        StateMachine stateMachine;
        public override void Initialize(PlayerLogicData Data, PlayerLogicParameter Parameter, LogicEvent Event)
        {
