...
namespace _Game.Character
{
    ...
    {
        public EnemyNavigationSystem(AbstractNavigationModule<EnemyNavigationData, EnemyNavigationParameter> module, CharacterParameterData data) : base(module, data)
        {}
